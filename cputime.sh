...
then
	...
	#Choses the longest CPU time, isolates the time data and stores the output to the variable cpu_time.
	...
	#Using the max_time searches for the corresponding job name and saves it the the variable job_name_max. 
